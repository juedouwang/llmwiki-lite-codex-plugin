"""T-06 Git 图谱可视化验收测试（AT-24 至 AT-27）。
...
class GitGraphAcceptanceTests(unittest.TestCase):
    """AT-24 至 AT-27 的 Git 图谱验收测试。"""

    def setUp(self):
        """Create a sample git repository for testing."""
        self._tmp = tempfile.TemporaryDirectory(prefix="llmwiki-git-graph-")
    ...
    def test_at24_basic_graph_loading(self):
    ...
    def test_at26_pagination_support(self):
    ...
    def test_at27_branch_switching(self):
    ...
    def test_lane_assignment_simple(self):
