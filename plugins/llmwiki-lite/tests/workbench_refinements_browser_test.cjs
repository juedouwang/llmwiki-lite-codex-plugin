...
(async()=>{
  ...
  try{
    ...
    await page.goto(origin+'/');await page.waitForURL(origin+'/daily');
    ...
    await page.waitForURL(origin+'/projects?context='+pid);
